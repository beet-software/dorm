...
class Dorm<Ref extends BaseReference<Ref>> {
  ...
  DatabaseEntity<ProductData, Product, Ref> get products => DatabaseEntity(
        const ProductEntity(),
        engine: _engine,
      );

  DatabaseEntity<CartData, Cart, Ref> get carts => DatabaseEntity(
        const CartEntity(),
        engine: _engine,
      );

  DatabaseEntity<CartItemData, CartItem, Ref> get cartItems => DatabaseEntity(
        const CartItemEntity(),
        engine: _engine,
      );

  DatabaseEntity<ReviewData, Review, Ref> get reviews => DatabaseEntity(
        const ReviewEntity(),
        engine: _engine,
      );
}
