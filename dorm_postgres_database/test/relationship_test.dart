...
import 'package:dorm_postgres_database/src/filter.dart';
import 'package:dorm_postgres_database/src/query.dart';
import 'package:dorm_postgres_database/src/relationship.dart';
...
class _Readable<Model, I extends Object>
  ...
  Future<List<Model>> peekAll([
    ...
    final Object? value = query.params.isEmpty
        ? null
