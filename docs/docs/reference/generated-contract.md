...
For a source library such as lib/models.dart, the application declares:
...
| File | Role |
| --- | --- |
| *.dorm.dart | dORM data/model types, fields, dependencies, entities, repositories, Dorm, and generated relation paths. |
| *.g.dart | JSON serialization helpers used by the generated types. |
