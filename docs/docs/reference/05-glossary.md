...
See [Build the first model](../01-start-here/02-build-the-first-model.md) and
[Annotations and generated API](02-annotations-and-generated-api.md).
...
See [Identity and dependencies](../03-understand/02-identity-and-dependencies.md).
...
See [How the pieces fit](../03-understand/01-how-the-pieces-fit.md) and
[Query and relationship details](../03-understand/04-query-and-relation-details.md).
...
See [Create, read, update, and remove](../02-build-the-store/01-crud.md).
...
See [Generate the model and repository API](../01-start-here/03-generate-the-model.md).
