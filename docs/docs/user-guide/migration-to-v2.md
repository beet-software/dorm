...
This guide updates an application from the latest published v1 prerelease to
the current dORM API.
...
Do not edit <i>*.dorm.dart</i> or <i>*.g.dart</i> to resolve migration errors. A stale
...
- Regenerate <i>*.dorm.dart</i> and <i>*.g.dart</i>.
